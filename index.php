...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                   ...
                   <a class="navbar-brand" href="index.php"><img alt="Brand" src="assets/img/hospital1.png" height="40px"></a> 
                </div>
                        ...
                        <script>
                            ...
                            function showUser(str) {
                                ...
                                if (str == "") {
                                    ...
                                    if (window.XMLHttpRequest) {     // used to req data from webserver 
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        ...
                        <div class="col-xs-10">
                            <h4>Immunologists</h4>
                            <p> They treat immune system disorders such as asthma, eczema, food allergies,and some autoimmune diseases.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-10">
                            ...
                            <p>These doctors give you drugs to numb your pain or to put you under during surgery, childbirth, or other procedures.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        ...
                        <div class="col-xs-10">
                            ...
                            <p>They care for the whole family, including children, adults, and the elderly. </p>
                        </div>
                    </div>
                </div>
                <!-- /.row -->
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
                <p class="pull-left small">© sahyadri Hospital <a href ="https://sahyadrihospital.com/"> contact </a></p>
